...
Obj = myFunctions();
Obj.config = "axial"; % this either "flexed" or "axial"
Obj = Obj.collectkneeDetails("Knee 4");
...
options = optimoptions('particleswarm','SwarmSize',9,'HybridFcn', @fmincon,'InertiaRange',[.5,1.5]);
